...
const AddHRRccm = () => {
  ...
  const { addHRRccm } = useContext(RestaurantsContext);
  ...
  const handleSubmit = async (e) => {
    ...
    console.log('ok');
    try {
      const response = await RestaurantFinder.post("/reporting/hr/rccm", {
        in_date,
        ap_no,
        accountability, 
        metix,
      ...
      addHRRccm(response.data.data.data);
    } catch (err) {
      console.log(err);
    }
  }; 
    ...
    <div className="mb-4">
      <form action="">
        <div className="form-group">
         ...
         <option value="absent_inform"   >Absent inform</option>
         <option value="absent_non_inform"   >Absent non inform</option>
           <option value="man_power"  >Man Power</option>
       <option value="reportable_accident"  >Reportable Accident</option>
       <option value="non_reportable_accident"  >Non Reportable Accident</option>
