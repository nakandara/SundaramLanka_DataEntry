...
const UpdateHRRccm = (props) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await RestaurantFinder.get(`/reporting/hr/rccm/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    const update = await RestaurantFinder.put(`/reporting/hr/rccm/${id}/update`, { 
      ap_no,
      accountability, 
      metix,
      target_date,
