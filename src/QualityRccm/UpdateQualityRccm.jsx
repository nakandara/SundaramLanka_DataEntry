...
const UpdateQualityRccm = (props) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await RestaurantFinder.get(`/reporting/quality/rccm/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    const update = await RestaurantFinder.put(`/reporting/quality/rccm/${id}/update`, {
      ap_no,
      accountability, 
      metix,
      target_date,
...
export default UpdateQualityRccm;
