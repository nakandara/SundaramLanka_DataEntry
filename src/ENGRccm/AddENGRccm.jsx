...
const AddENGRccm = () => {
  ...
  const { addENGRccm } = useContext(RestaurantsContext);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      addENGRccm(response.data.data.data);
    } catch (err) {
      console.log(err);
    }
  }; 
    ...
    <div className="m-5">
      <form action="">
        <div className="form-group">
         ...
         <option value="energy_cost_kg"   >Energy Cost</option>
           <option value="firewood_cost_rate"  >Firewood Cost</option>
       <option value="break_down"  >BreakDown</option>
      </select>
          </div>
