...
const UpdateMixingRccm = (props) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await RestaurantFinder.get(`/reporting/mixing/rccm/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    const update = await RestaurantFinder.put(`/reporting/mixing/rccm/${id}/update`, {
      ap_no,
      accountability, 
      metix,
      target_date,
...
export default UpdateMixingRccm;
