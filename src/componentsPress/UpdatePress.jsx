...
const UpdatePress = (props) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      console.log(response.data.data.data.sn);
  ...
  const handleSubmit = async (e) => {
    ...
    //   rating,
    // });
    const update = await RestaurantFinder.post(`/pressdata/press/update/${sn}`, { sn,press_no,shift,tyre_type
     ,
    });
   console.log(update);
    history.push("/press");
