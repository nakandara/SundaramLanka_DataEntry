...
const SucessICPC = () => {
    ...
    const { icpcsucess,setSucessicpc,datem, setDatem,ddate, setDdate} = useContext(RestaurantsContext);
...
useEffect(() => {
    const fetchData = async () => {
        try {
          ...
          setSucessicpc(response.data.data.data);
