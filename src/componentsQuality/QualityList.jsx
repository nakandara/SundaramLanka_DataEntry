...
const QualityList = (props) => {
  const { restaurants, setRestaurants, addSucess,quality,setQuality } = useContext(
    RestaurantsContext
  );
const [refresh, setRefresh] = useState(false)
  ...
  const fetchData = async () => {
    try {
      const response = await RestaurantFinder.get("/reporting/quality");
      
      setQuality(response.data.data.data);
      ...
      <table className="table table-hover table-dark"   >
        <thead>
          <tr className="bg-primary">
            ...
            <th scope="col">L</th>
            <th scope="col">C</th> 
            <th scope="col">BERLC</th>
            <th scope="col">NM Dirty</th>
            ...
            quality.map((d,index) => {
              return (
                ...
                >
                  ...
                  <td>{d.l}</td>
                  <td>{d.c}</td> 
                  <td className='wrap'>{d.berlc}</td>
                  <td className='wrap'>{d.nm_dirty_tires}</td>
