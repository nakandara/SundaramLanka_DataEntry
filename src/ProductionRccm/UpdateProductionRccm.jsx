...
const UpdateProductionRccm = (props) => {
  const { id } = useParams();
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await RestaurantFinder.get(`/reporting/production/rccm/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    const update = await RestaurantFinder.put(`/reporting/production/rccm/${id}/update`, {
      ap_no,
      accountability, 
      metix,
      target_date,
...
export default UpdateProductionRccm;
