...
const AddProductionRccm = () => {
  let history = useHistory();
  const { addProductionRccm } = useContext(RestaurantsContext);
  ...
  const handleSubmit = async (e) => {
    ...
    console.log('ok');
    try {
      const response = await RestaurantFinder.post("/reporting/production/rccm", {
        in_date,
        ap_no,
        accountability, 
        metix,
      ...
      addProductionRccm(response.data.data.data);
    } catch (err) {
      console.log(err);
    }
  }; 
  ...
  return (
    <div className="m-1" style={{margin:'30px'}}>
    <div className="mb-4">
      <form action="">
        <div className="form-group">
         ...
         <option value="plant_utilization"   >Plant Utilization</option>
...
export default AddProductionRccm;
